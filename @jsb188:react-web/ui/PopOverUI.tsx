...
export const POListSubtitle = memo((p: POListSubtitleProps) => {
  ...
  return (
    <div className='po_subtitle bd_b_1 bd_lt ft_xs h_item bg z2 shadow_bg rel'>
      ...
      {colorIndicator && <span className={`color_indicator no_shrink mr_5 shift_up bg_${colorIndicator}`} />}
...
export const POListItem = memo((p: PONavItemBase & {
  ...
  return (
    ...
    >
      ...
      {colorIndicator && <span className={`color_indicator no_shrink bg_${colorIndicator}`} />}
