export default {
    ...
    ai_inbox_desc: {
      ...
      agent: 'Handle general requests.',
		...
		inbound_email_from: 'From',
		inbound_email_to: 'To',
		inbound_email_subject: 'Subject',
		inbound_email_received: 'Received',
		inbound_email_summary: 'Summary',
		inbound_email_body: 'Email',
		inbound_email_no_subject: '(No subject)',
		inbound_email_no_body: 'There is no message body for this email.',
		inbound_email_attachment_size: '%{size} bytes',
