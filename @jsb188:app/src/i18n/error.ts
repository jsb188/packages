export default {
  en: {
    ...
    10013: 'Our email service is experiencing an outage. Please try again in a moment.',

    // 2x

    20000: '"%{value}" is not allowed.',
    20001: '"%{value}" is not a valid email domain.',
    ...
    20006: 'Could not find the account with that email. (%{value})',
    ...
    20013: 'Account already exists with that email address. (%{value})',
    ...
    20018: "Your email is already verified. There's no need to verify your email again.",
    ...
    20025: 'Account associated with "%{value}" has been banned. If this is an error, please send us an email.',
    ...
    20062: '"%{value}" is not a valid email address.',
    ...
    20071: 'This data table could not be found.\nIt may have been deleted.',
    ...
    30025: 'Email server is experiencing an outage. Please try again in a moment.',
    ...
    msg_email_invalid: '"%{value}" is an invalid email address.',
