export default {
  en: {
    ...
    warning: 'Warning',
    cancel: 'Cancel',
    click_to_drag_window: 'Click & hold to drag this window',
    continue: 'Continue',
    ...
    delete_document_msg: 'Are you sure you want to delete this\n document and all its pages?',
    ...
    press_enter_to_save: 'Press the enter key to save',
    saving_: 'Saving...',
    ...
    customer: 'Customer',
    inbound_contacts: 'Inbound contacts',
    vendors: 'Vendors',
    'vendors_#': 'Vendors #',
    vendor: 'Vendor',
    ...
    memory: 'Memory',
    memories: 'Memories',
    ai_memories_desc: 'AI may periodically update or replace its own memories with new information.',
    answer: 'Answer',
    details: 'Details',
    source: 'Source',
    directory: 'Directory',
    ...
    saved_: 'Saved %{date}.',
		saved_source_: 'Saved %{date} via %{source}.',
    category: 'Category',
    activity: 'Activity',
