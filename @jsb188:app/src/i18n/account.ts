export default {
  en: {
    ...
    username_info: 'Username, ID, and email is used to log in to your account.',
    email: 'Email',
    email_ph: 'e.g. jane_doe@email.com',
    email_ph2: 'jane_doe@email.com',
    phone_ph: 'e.g. 123-444-5555',
    phone_ph2: '123-444-5555',
    password: 'Password',
    ...
    email_updated_msg: 'Your email address has been updated to:\n %{emailAddress}.',
    change_email: 'Change email',
    change_email_msg: 'You will receive a confirmation email\n to your new address.',
    change_email_pw_confirm_msg: 'Please confirm your identity to\n change your email address.',
    change_email_verify_msg: 'Follow the instructions in the email we sent\n to change your email address.',
    change_password_msg: 'Enter your new password below.',
    change_password_pw_confirm_msg: 'Please confirm your identity to\n change your password.',
    change_phone: 'Change phone',
    change_phone_msg: 'Please confirm your identity to\n change your phone number.',
    change_phone_request_msg: 'Enter your new phone number below.\n We will send you a verification code.',
    change_phone_verify_msg: 'Enter the verification code\n sent to your new phone number.',
    currentPassword: 'Current password',
    newPassword: 'New password',
    newPasswordRepeat: 'New password (repeat)',
    phone_updated: 'Number updated',
    phone_updated_msg: 'Your phone number has been updated to:\n [hl]%{phoneNumber}[/hl].',
