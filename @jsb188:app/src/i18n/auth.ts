export default {
  en: {
    ...
    sign_in_w_existing: 'Sign in with an existing account',
    sign_in_other_methods: 'Sign in using other methods',
    ...
    add_password_sign_in_msg: 'Please add a password to your account (%{identifier}) for security.',
